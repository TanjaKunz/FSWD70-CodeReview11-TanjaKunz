   ...
   <div class="container-fluid mb-5">
      ...
      <main role="main" class="container-fluid p-3">
        ...
        <div class="row mt-5">
          ...
          <?php
           $sql = "SELECT locations.loc_id, locations.name, locations.description, locations.image, locations.loc_type, address.address, address.ZIP, address.city, address.state FROM locations 
