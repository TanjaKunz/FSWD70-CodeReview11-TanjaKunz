  ...
  <div class="container-fluid mb-5">
      <header class="fixed-top">
         <div class="col-12 d-flex" id="header">
            <p class="h1 align-self-center text-light"><i class="far fa-map pr-3"></i>Update User</p>            
         </div>
    ...
    <main>
      ...
      <form action="actions/a_update.php"  method="post">
        ...
        <label>Name</label>
        <input type="text" name="name" class="form-control" placeholder="Name" maxlength="50" value="<?php echo $data['name'] ?>" autofocus>
        ...
        <input type="hidden" name="role" class="form-control" placeholder="Role" maxlength="50" value="<?php echo $data['role'] ?>" autofocus>
        ...
        <div class="mt-3">
          ...
          <a href="home.php"><button class="btn btn-secondary" type="button" >Back</button></a>
        </div>      
      </form>
      </fieldset>
    </main>
