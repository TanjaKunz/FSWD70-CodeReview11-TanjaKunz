SELECT locations.name, locations.description, locations.image, locations.loc_type, address.address, address.ZIP, address.city, address.state, restaurants.phone, restaurants.web, rest_type.rest_type, places.web, place_type.type, concerts.web, concerts.date, concerts.time 
FROM locations
